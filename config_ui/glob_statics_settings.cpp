...
const StaticSettingsMap &StaticSettingsMap::getGlobalSetts()
{
    ...
    const static StaticSettingsMap list({
                                            ...
                                            DECL_SETT(GlobalStorableInt, "Int_mem_pressure", 30, tr("RAM pressure by the program measured in percents."), tr("This value defines how much RAM will be used to cache loaded images."),
                                            20, 95),
                                        });
    return list;
}
